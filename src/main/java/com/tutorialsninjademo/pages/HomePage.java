...
public class HomePage extends Utility {
    ...
    public void selectMenu(String menu) {
        if (menu == "Desktops") {
            ...
            mouseHoverToElement((By) desktopTab);
            ...
            mouseHoverToElement((By) laptopsAndNoteBooksTab);
            ...
            mouseHoverToElement((By) componentsTab);
    ...
    public void mouseHoverAndClickOnDesktop() {
        ...
        mouseHoverToElementAndClick((By) desktopTab);
    ...
    public void mouseHoverAndClickOnLaptopsAndNotebooks() {
        ...
        mouseHoverToElementAndClick((By) laptopsAndNoteBooksTab);
    ...
    public void mouseHoverAndClickOnComponents() {
        ...
        mouseHoverToElementAndClick((By) componentsTab);
